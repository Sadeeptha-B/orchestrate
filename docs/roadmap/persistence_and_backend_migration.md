> **What is this?** A forward-looking roadmap document — analysis and framing for an infrastructure decision that is **not yet committed**. It is not current-state documentation. For the current state see [../synthesis.md](../synthesis.md); for the durable "why" see [../vision.md](../vision.md). Companion roadmap doc: [engagement_record_strategy.md](./engagement_record_strategy.md).
