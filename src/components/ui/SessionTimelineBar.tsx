...
import { eventTimeRange, isoLocalHHMM, packExternalEvents } from '../../lib/timelineEvents';
...
// day context — not in a lane of their own. The positioning math (`packExternalEvents`) lives in
// `lib/timelineEvents` so the editable `SessionEditorTimeline` shares it. Row-packing only spreads
// overlapping events' labels across rows so they don't collide; the bars are never editable here.

// Re-exported for callers that historically imported these from here (e.g. ConfigurationSettings).
